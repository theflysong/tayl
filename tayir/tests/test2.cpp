...
void test2() {
    ...
    //                 Operand(OperandType::IMMEDIATE, OperandPos::SRC2, "2"),
    //                 Operand(OperandPos::SRC3)
    //             )
    //         )
    //         .AppendIns(
    ...
    //                 InsType::RET,
    //                 Operand(OperandPos::DEST),
    //                 Operand(OperandType::IMMEDIATE, OperandPos::SRC1, "0"),
    //                 Operand(OperandPos::SRC2),
    //                 Operand(OperandPos::SRC3)
    //             )
    //         )
